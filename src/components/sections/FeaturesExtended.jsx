      ...
      <SectionArea id="service" className="squares">
        ...
        <SectionWrapper>
          <div className="flex flex-col items-center w-full justify-evenly tablet1:flex-row">
            <div className="flex flex-wrap items-start justify-between desktop2:justify-center w-full gap-[50px]">
              <MotionDivDownToUp className="flex flex-col items-center justify-center border-[2px] border-solid px-[10px] py-[20px] bg-white w-full tablet1:w-[45%] desktop2:w-[35%]">
